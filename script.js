...
// // to open and close the  modal container
// let isModalPresent=false;
// addBtn.addEventListener('click',function(){
//     if(!isModalPresent)
//     {
//         modalCont.style.display="flex";
//         //modal add ho gaya hai screen pr
//     } else {
...
//         // stringify is udes to convert the object values into string 

//     }
// };

// //get all the tickets from the local storage
// if(localStorage.getItem("tickets")){
//     ticketsArr=JSON.parse(localStorage.getItem("tickets"));
//     //parse is used to convert string elements into 
//     //objects
...
//     let fileteredTickets=ticketsArr.filter(function (ticketObj){
...
//     fileteredTickets.forEach(function(ticketObj){
//         createTicket(ticketObj.ticketColor,ticketObj.data,ticketObj.ticketId);
//     })
// })
...
//         //remove all the colors specific tickets
//         let allTickets=document.querySelectorAll(".ticket-cont");
//         for(let i =0;i <allTickets.length;i++)
//         {
//             allTickets[i].remove();
...
// // for the unique random ids we have used the uuid website 
// // and we are using version 4 for all random
// // for this we need to install a package by cmd
// // npm i uuid
// // we can not ud=se uuid as it for node and we are making our project purely in Browser
// // so we need to unpackage the npm package for that we will search unpackage uuid 
// // and there is a website for it and from there well copy the script for browser for version 1 
